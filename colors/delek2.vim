...
hi Normal     guifg=Black  guibg=#ffffdf
if &t_Co == 256
...
" syntax highlighting
hi Comment    gui=NONE guifg=red2
hi Constant   gui=NONE guifg=green3
hi Identifier gui=NONE guifg=cyan4
hi PreProc    gui=NONE guifg=magenta3
hi Special    gui=NONE guifg=deeppink
hi Statement  gui=bold guifg=blue
hi Type	      gui=bold guifg=blue

if &t_Co == 256
	hi Comment    cterm=NONE ctermfg=160
	hi Constant   cterm=NONE ctermfg=41
	hi Identifier cterm=NONE ctermfg=50
	hi PreProc    cterm=NONE ctermfg=200
	hi Special    cterm=NONE ctermfg=197
